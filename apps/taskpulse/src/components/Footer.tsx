      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2 text-xl font-bold text-white hover:text-primary transition-colors duration-200">
            ...
            <p className="mt-4 text-sm text-surface-400 max-w-xs leading-relaxed">
              Streamline your workflow, collaborate seamlessly, and deliver projects on time with TaskPulse.
            </p>
            <div className="flex items-center gap-4 mt-6">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="text-surface-400 hover:text-primary transition-colors duration-200"
